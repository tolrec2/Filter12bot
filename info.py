...
JOIN_CHANNELS = [int(-1001896241336), int(-1001956948857)]
...
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", f"{script.BATCH_FILE_CAPTION}")
...
URL = "https://stream1-db772ce6f898.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://stream1-db772ce6f898.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://stream1-db772ce6f898.herokuapp.com/".format(FQDN)
else:
    URL = "https://stream1-db772ce6f898.herokuapp.com/".format(FQDN)
